...
namespace IO.Swagger.Api
{
    ...
    public interface IPlayerApi : IApiAccessor
    {
        ...
        ApiResponse<ExecuteMethodResponse> ExecuteMethodWithHttpInfo (string player, ExecuteMethodRequest body = null, bool? details = null, string accept = null, bool? pretty = null);
        /// <summary>
        /// Get a player
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ExecuteMethodResponse> ExecuteMethodAsync (string player, ExecuteMethodRequest body = null, bool? details = null, string accept = null, bool? pretty = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ExecuteMethodResponse>> ExecuteMethodAsyncWithHttpInfo (string player, ExecuteMethodRequest body = null, bool? details = null, string accept = null, bool? pretty = null);
        /// <summary>
        /// Get a player
        /// </summary>
        /// <remarks>
    ...
    public partial class PlayerApi : IPlayerApi
    {
        ...
        /// <summary>
        /// Execute a method Provides direct access to the underlying player object and can execute any method on it.     **Required permissions:**    - **player.method**   
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="player">The uuid of the player</param>
        /// <param name="body"> (optional)</param>
        ...
        /// <param name="pretty">Add to make the Web-API pretty print the response (useful for debugging your requests) (optional)</param>
        /// <returns>ExecuteMethodResponse</returns>
        public ExecuteMethodResponse ExecuteMethod (string player, ExecuteMethodRequest body = null, bool? details = null, string accept = null, bool? pretty = null)
        {
             ApiResponse<ExecuteMethodResponse> localVarResponse = ExecuteMethodWithHttpInfo(player, body, details, accept, pretty);
        ...
        /// <param name="pretty">Add to make the Web-API pretty print the response (useful for debugging your requests) (optional)</param>
        /// <returns>ApiResponse of ExecuteMethodResponse</returns>
        public ApiResponse< ExecuteMethodResponse > ExecuteMethodWithHttpInfo (string player, ExecuteMethodRequest body = null, bool? details = null, string accept = null, bool? pretty = null)
        {
            // verify the required parameter 'player' is set
            if (player == null)
                throw new ApiException(400, "Missing required parameter 'player' when calling PlayerApi->ExecuteMethod");

            var localVarPath = "/player/{player}/method";
            ...
            if (player != null) localVarPathParams.Add("player", this.Configuration.ApiClient.ParameterToString(player)); // path parameter
        ...
        /// <param name="pretty">Add to make the Web-API pretty print the response (useful for debugging your requests) (optional)</param>
        /// <returns>Task of ExecuteMethodResponse</returns>
        public async System.Threading.Tasks.Task<ExecuteMethodResponse> ExecuteMethodAsync (string player, ExecuteMethodRequest body = null, bool? details = null, string accept = null, bool? pretty = null)
        {
             ApiResponse<ExecuteMethodResponse> localVarResponse = await ExecuteMethodAsyncWithHttpInfo(player, body, details, accept, pretty);
             return localVarResponse.Data;
        ...
        /// <param name="pretty">Add to make the Web-API pretty print the response (useful for debugging your requests) (optional)</param>
        /// <returns>Task of ApiResponse (ExecuteMethodResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ExecuteMethodResponse>> ExecuteMethodAsyncWithHttpInfo (string player, ExecuteMethodRequest body = null, bool? details = null, string accept = null, bool? pretty = null)
        {
            // verify the required parameter 'player' is set
            if (player == null)
                throw new ApiException(400, "Missing required parameter 'player' when calling PlayerApi->ExecuteMethod");
        ...
        /// <summary>
        /// Get a player Get detailed information about a player.     **Required permissions:**    - **player.one**   
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="player">The uuid of the player</param>
        /// <param name="details">Add to include additional details, omit or false otherwise (optional)</param>
        ...
        public ApiResponse< Player > GetPlayerWithHttpInfo (string player, bool? details = null, string accept = null, bool? pretty = null)
        {
            // verify the required parameter 'player' is set
            if (player == null)
                throw new ApiException(400, "Missing required parameter 'player' when calling PlayerApi->GetPlayer");

            var localVarPath = "/player/{player}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <summary>
        /// List players Get a list of all the players on the server.     **Required permissions:**    - **player.list**   
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="details">Add to include additional details, omit or false otherwise (optional)</param>
        /// <param name="accept">Override the &#39;Accept&#39; request header (useful for debugging your requests) (optional)</param>
        ...
        /// <summary>
        /// Modify a player Modify the properties of an existing player.     **Required permissions:**    - **player.modify**   
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="player">The uuid of the player</param>
        /// <param name="body"> (optional)</param>
        ...
        public ApiResponse< Player > ModifyPlayerWithHttpInfo (string player, UpdatePlayerRequest body = null, bool? details = null, string accept = null, bool? pretty = null)
        {
            // verify the required parameter 'player' is set
            if (player == null)
                throw new ApiException(400, "Missing required parameter 'player' when calling PlayerApi->ModifyPlayer");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("ModifyPlayer", localVarResponse);
                if (exception != null) throw exception;
            }

...
namespace IO.Swagger.Model
{
    ...
    public partial class CreateEntityRequest :  IEquatable<CreateEntityRequest>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="World">The UUID or name of the world to create the entity in..</param>
        /// <param name="Position">Position.</param>
        /// <param name="Type">The type of the entity. Check &#x60;/registry/org.spongepowered.api.entity.EntityType&#x60;..</param>
        public CreateEntityRequest(string World = default(string), Vector3 Position = default(Vector3), string Type = default(string))
        {
            this.World = World;
        ...
        /// </summary>
        /// <value>The UUID or name of the world to create the entity in.</value>
        ...
        /// </summary>
        /// <value>The type of the entity. Check &#x60;/registry/org.spongepowered.api.entity.EntityType&#x60;.</value>

...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GameMode :  IEquatable<GameMode>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The name of the game mode</value>
        ...
        {
            return this.Equals(input as GameMode);
        }

        /// <summary>
        /// Returns true if GameMode instances are equal
        /// </summary>
        /// <param name="input">Instance of GameMode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GameMode input)
        {
            if (input == null)
                return false;

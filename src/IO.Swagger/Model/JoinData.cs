...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class JoinData :  IEquatable<JoinData>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The first time this entity joined the server</value>
        ...
        /// </summary>
        /// <value>The most recent time this entity joined the server</value>
        ...
        {
            return this.Equals(input as JoinData);
        }

        /// <summary>
        /// Returns true if JoinData instances are equal
        /// </summary>
        /// <param name="input">Instance of JoinData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JoinData input)
        {
            if (input == null)
                return false;

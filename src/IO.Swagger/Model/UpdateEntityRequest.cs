...
namespace IO.Swagger.Model
{
    ...
    public partial class UpdateEntityRequest :  IEquatable<UpdateEntityRequest>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="World">The UUID or name of the world that the entity is moved to..</param>
        /// <param name="Position">Position.</param>
        /// <param name="Velocity">Velocity.</param>
        /// <param name="Rotation">Rotation.</param>
        /// <param name="Scale">Scale.</param>
        /// <param name="Damage">Damage.</param>
        public UpdateEntityRequest(string World = default(string), Vector3 Position = default(Vector3), Vector3 Velocity = default(Vector3), Vector3 Rotation = default(Vector3), Vector3 Scale = default(Vector3), DamageRequest Damage = default(DamageRequest))
        {
            this.World = World;
        ...
        /// </summary>
        /// <value>The UUID or name of the world that the entity is moved to.</value>

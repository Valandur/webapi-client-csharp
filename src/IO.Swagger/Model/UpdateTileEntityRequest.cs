...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateTileEntityRequest :  IEquatable<UpdateTileEntityRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The ItemStacks in the inventory of the tile entity</value>
        ...
        {
            return this.Equals(input as UpdateTileEntityRequest);
        }

        /// <summary>
        /// Returns true if UpdateTileEntityRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateTileEntityRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateTileEntityRequest input)
        {
            if (input == null)
                return false;

...
namespace IO.Swagger.Model
{
    ...
    public partial class VehicleData :  IEquatable<VehicleData>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The base vehicle entity</value>
        [DataMember(Name="baseVehicle", EmitDefaultValue=false)]
        public EntitySnapshot BaseVehicle { get; set; }

        /// <summary>
        /// The vehicle entity itself
        /// </summary>
        /// <value>The vehicle entity itself</value>
        [DataMember(Name="vehicle", EmitDefaultValue=false)]
        public EntitySnapshot Vehicle { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BaseVehicle: ").Append(BaseVehicle).Append("\n");
        ...
        public bool Equals(VehicleData input)
        {
            ...
            return 
                (
                    this.BaseVehicle == input.BaseVehicle ||
                    (this.BaseVehicle != null &&
                    this.BaseVehicle.Equals(input.BaseVehicle))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.BaseVehicle != null)
                    hashCode = hashCode * 59 + this.BaseVehicle.GetHashCode();

...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BlockChangeOperation : BlockOperation,  IEquatable<BlockChangeOperation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BlockChangeOperation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BlockChangeOperation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BlockChangeOperation" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as BlockChangeOperation);
        }

        /// <summary>
        /// Returns true if BlockChangeOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of BlockChangeOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BlockChangeOperation input)
        {
            if (input == null)
                return false;

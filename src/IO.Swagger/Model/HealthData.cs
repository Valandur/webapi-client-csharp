...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HealthData :  IEquatable<HealthData>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The current health of the entity</value>
        ...
        /// </summary>
        /// <value>The maximum health of the entity</value>
        ...
        {
            return this.Equals(input as HealthData);
        }

        /// <summary>
        /// Returns true if HealthData instances are equal
        /// </summary>
        /// <param name="input">Instance of HealthData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HealthData input)
        {
            if (input == null)
                return false;

...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SlotPos :  IEquatable<SlotPos>, IValidatableObject
    {
        /// <summary>
        /// Defines _Operator
        /// </summary>
        ...
        public SlotPos(OperatorEnum? _Operator = default(OperatorEnum?), string Key = default(string), Vector2i Value = default(Vector2i), int? X = default(int?), int? Y = default(int?))
        {
        ...
        {
            return this.Equals(input as SlotPos);
        }

        /// <summary>
        /// Returns true if SlotPos instances are equal
        /// </summary>
        /// <param name="input">Instance of SlotPos to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SlotPos input)
        {
            if (input == null)
                return false;

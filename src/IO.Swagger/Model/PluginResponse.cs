...
namespace IO.Swagger.Model
{
    ...
    public partial class PluginResponse :  IEquatable<PluginResponse>, IValidatableObject
    {
        ...
        public PluginResponse(Ok Ok = default(Ok), PluginFull Plugin = default(PluginFull))
        {
            this.Ok = Ok;
            this.Plugin = Plugin;
        }
        ...
        public PluginFull Plugin { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PluginResponse);
        }

        /// <summary>
        /// Returns true if PluginResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PluginResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PluginResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExecuteMethodParam :  IEquatable<ExecuteMethodParam>, IValidatableObject
    {
        /// <summary>
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum VECTOR3D for value: VECTOR3D
            /// </summary>
            [EnumMember(Value = "VECTOR3D")]
            VECTOR3D = 14,
            
            /// <summary>
            /// Enum VECTOR3I for value: VECTOR3I
            /// </summary>
            ...
            /// <summary>
            /// Enum ITEMSTACK for value: ITEMSTACK
            /// </summary>
        ...
        {
            return this.Equals(input as ExecuteMethodParam);
        }

        /// <summary>
        /// Returns true if ExecuteMethodParam instances are equal
        /// </summary>
        /// <param name="input">Instance of ExecuteMethodParam to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExecuteMethodParam input)
        {
            if (input == null)
                return false;

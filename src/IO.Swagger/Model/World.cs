...
namespace IO.Swagger.Model
{
    ...
    public partial class World :  IEquatable<World>, IValidatableObject
    {
        ...
        public World(string Name = default(string), string Uuid = default(string), string Link = default(string))
        {
            this.Name = Name;
            this.Uuid = Uuid;
            this.Link = Link;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as World);
        }

        /// <summary>
        /// Returns true if World instances are equal
        /// </summary>
        /// <param name="other">Instance of World to be compared</param>
        /// <returns>Boolean</returns>

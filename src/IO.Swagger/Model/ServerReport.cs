...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ServerReport :  IEquatable<ServerReport>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ServerReport);
        }

        /// <summary>
        /// Returns true if ServerReport instances are equal
        /// </summary>
        /// <param name="input">Instance of ServerReport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServerReport input)
        {
            if (input == null)
                return false;

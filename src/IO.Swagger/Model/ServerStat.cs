...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ServerStat :  IEquatable<ServerStat>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServerStat" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ServerStat() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ServerStat" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ServerStat);
        }

        /// <summary>
        /// Returns true if ServerStat instances are equal
        /// </summary>
        /// <param name="input">Instance of ServerStat to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServerStat input)
        {
            if (input == null)
                return false;

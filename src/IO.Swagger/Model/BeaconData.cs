...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BeaconData :  IEquatable<BeaconData>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The primary effect of the beacon</value>
        [DataMember(Name="primary", EmitDefaultValue=false)]
        public CatalogType Primary { get; set; }

        /// <summary>
        /// The secondary effect of the beacon
        /// </summary>
        /// <value>The secondary effect of the beacon</value>
        [DataMember(Name="secondary", EmitDefaultValue=false)]
        public CatalogType Secondary { get; set; }
        ...
        {
            return this.Equals(input as BeaconData);
        }

        /// <summary>
        /// Returns true if BeaconData instances are equal
        /// </summary>
        /// <param name="input">Instance of BeaconData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BeaconData input)
        {
            if (input == null)
                return false;

...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PickupDelayData :  IEquatable<PickupDelayData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PickupDelayData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PickupDelayData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PickupDelayData" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <value>The delay that entities must wait to pick up this entity</value>
        ...
        /// </summary>
        /// <value>True if other entities can never pick up this entity, false otherwise</value>
        ...
        {
            return this.Equals(input as PickupDelayData);
        }

        /// <summary>
        /// Returns true if PickupDelayData instances are equal
        /// </summary>
        /// <param name="input">Instance of PickupDelayData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PickupDelayData input)
        {
            if (input == null)
                return false;

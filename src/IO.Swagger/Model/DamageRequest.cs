...
namespace IO.Swagger.Model
{
    ...
    public partial class DamageRequest :  IEquatable<DamageRequest>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The amount of damage that should be dealt to the entity</value>
        ...
        /// </summary>
        /// <value>The type of damage that should be dealt</value>
        ...
        {
            return this.Equals(input as DamageRequest);
        }

        /// <summary>
        /// Returns true if DamageRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DamageRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DamageRequest input)
        {
            if (input == null)
                return false;

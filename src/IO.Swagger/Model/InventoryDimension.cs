...
namespace IO.Swagger.Model
{
    ...
    public partial class InventoryDimension :  IEquatable<InventoryDimension>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as InventoryDimension);
        }

        /// <summary>
        /// Returns true if InventoryDimension instances are equal
        /// </summary>
        /// <param name="input">Instance of InventoryDimension to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InventoryDimension input)
        {
            if (input == null)
                return false;

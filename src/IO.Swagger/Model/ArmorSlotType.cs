...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ArmorSlotType :  IEquatable<ArmorSlotType>, IValidatableObject
    {
        /// <summary>
        /// Defines _Operator
        /// </summary>
        ...
        {
            return this.Equals(input as ArmorSlotType);
        }

        /// <summary>
        /// Returns true if ArmorSlotType instances are equal
        /// </summary>
        /// <param name="input">Instance of ArmorSlotType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArmorSlotType input)
        {
            if (input == null)
                return false;

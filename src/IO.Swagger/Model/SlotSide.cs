...
namespace IO.Swagger.Model
{
    ...
    public partial class SlotSide :  IEquatable<SlotSide>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as SlotSide);
        }

        /// <summary>
        /// Returns true if SlotSide instances are equal
        /// </summary>
        /// <param name="input">Instance of SlotSide to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SlotSide input)
        {
            if (input == null)
                return false;

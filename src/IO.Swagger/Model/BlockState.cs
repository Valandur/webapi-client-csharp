...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BlockState :  IEquatable<BlockState>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Additional data attached to the block state</value>
        ...
        /// </summary>
        /// <value>The type of block this block state is from</value>
        ...
        {
            return this.Equals(input as BlockState);
        }

        /// <summary>
        /// Returns true if BlockState instances are equal
        /// </summary>
        /// <param name="input">Instance of BlockState to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BlockState input)
        {
            if (input == null)
                return false;

...
namespace IO.Swagger.Test
{
    ...
    public class HistoryApiTests
    {
        ...
        public void GetChatHistoryTest()
        {
            ...
            //var response = instance.GetChatHistory();
            //Assert.IsInstanceOf<ChatHistoryResponse> (response, "response is ChatHistoryResponse");
        }
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.GetCommandHistory();
            //Assert.IsInstanceOf<CommandHistoryResponse> (response, "response is CommandHistoryResponse");
        }

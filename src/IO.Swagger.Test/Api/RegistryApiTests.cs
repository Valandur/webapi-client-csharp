...
namespace IO.Swagger.Test
{
    ...
    public class RegistryApiTests
    {
        ...
        /// <summary>
        /// Test GetCatalogValues
        /// </summary>
        [Test]
        public void GetCatalogValuesTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string className = null;
            //var response = instance.GetCatalogValues(className);
            //Assert.IsInstanceOf<CatalogTypesResponse> (response, "response is CatalogTypesResponse");
        }

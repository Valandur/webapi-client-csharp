...
namespace Example
{
    public class CreateRegionExample
    {
        public void main()
        {
            ...
            var apiInstance = new RedProtectApi();
            var body = new RedProtectRegion(); // RedProtectRegion |  (optional) 
            ...
            {
                Debug.Print("Exception when calling RedProtectApi.CreateRegion: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class DeleteRegionExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling RedProtectApi.DeleteRegion: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class GetRegionExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling RedProtectApi.GetRegion: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class ListRegionsExample
    {
        public void main()
        {
            ...
            var apiInstance = new RedProtectApi();
            var world = world_example;  // string |  (optional) 
            var details = true;  // bool? | Add to include additional details, omit or false otherwise (optional) 
            var accept = accept_example;  // string | Override the 'Accept' request header (useful for debugging your requests) (optional) 
            var pretty = true;  // bool? | Add to make the Web-API pretty print the response (useful for debugging your requests) (optional) 
            ...
            {
                Debug.Print("Exception when calling RedProtectApi.ListRegions: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class ModifyRegionExample
    {
        public void main()
        {
            // Configure API key authorization: ApiKeyHeader
            ...
            {
                Debug.Print("Exception when calling RedProtectApi.ModifyRegion: " + e.Message );
            }
        }
    }
}

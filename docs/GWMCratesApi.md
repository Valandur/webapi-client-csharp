...
<a name="listcrates"></a>
# **ListCrates**
> List<CachedObject> ListCrates (bool? details = null, string accept = null, bool? pretty = null)
...
namespace Example
{
    public class ListCratesExample
    {
        public void main()
        {
            ...
            var apiInstance = new GWMCratesApi();
            ...
            {
                Debug.Print("Exception when calling GWMCratesApi.ListCrates: " + e.Message );
            }
        }
    }
}
